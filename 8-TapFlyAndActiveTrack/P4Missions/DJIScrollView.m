...
- (void)setup {
    ...
    self.statusTextView = [[UILabel alloc] initWithFrame:CGRectMake(20, 0, self.scrollView.frame.size.width - 40, 50 * self.scrollView.frame.size.height)];
...
-(void)setDefaultSize {
    ...
    NSUInteger height = screenRect.size.height - 120;
    NSUInteger width = screenRect.size.width - 30;
